                ...
                <div class="col-12 col-lg-12 order-2 order-md-3 order-lg-2 mb-4">
                  <div class="card">
                    <div class="row row-bordered g-0">
                        ...
                        <h5 class="card-header m-0 me-2 pb-3">Compose Message</h5>
                        <hr>
                        <?php
...
// }
 ...
 <!-- FORM -->
 <form action="message-configuration.php" method="POST" style="margin-bottom:10px !important;
  ...
  $selectEmail=mysqli_query($conn,"select * from tenants");
              ...
              <div class="form-group mt-3"  style="width:300px  !important" >
                  ...
                  <option selected value="">--Reciptient--</option>
                    ...
                    ?>
                      ...
                      <option value="<?php echo $emails['mobileNumber']?>"><?php echo $emails['mobileNumber'].' '.$emails['firstname'].' '.$emails['lastname']?></option>
    ...
    <div class="mt-3 mb-3 lname">
      ...
      <input type="hidden" class="form-control" name="id" style="width:300px  !important" id="subject" required placeholder="Subject">
    </div>
