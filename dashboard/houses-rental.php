...
<?php include 'main-menu.php'?>
  ...
  <i class="fas fa-plus"></i> House
              ...
              . "' data-rental='" . $houses['rentalFee']  . $houses['attachment'] ."'>";
                        ?>
...
<h3 style="margin-top:30px">Update Record</h3>
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" name="address" id="address" >
          ...
          <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Annual fee</label>
    <input type="text" class="form-control" name="rental" id="rental" disabled>
  </div>
