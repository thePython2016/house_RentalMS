                ...
                <div class="col-12 col-lg-12 order-2 order-md-3 order-lg-2 mb-4">
                  <div class="card">
                    <div class="row row-bordered g-0">
                        ...
                        <h5 class="card-header m-0 me-2 pb-3">Rentals List</h5>
                        <hr>
...
?>
                              ...
                              <tr>
                              <td><a class="new-page" href="payment-number.php?paymentnumber=<?php echo $payment['paymentNumber']?>"><?php echo $payment['paymentNumber']?></a></td>
