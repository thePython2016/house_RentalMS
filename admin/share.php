          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="col-lg-12 col-md-12 col-12 mb-4">
                    <button type="button" class="btn btn-success addBtn">Add Share</button>
...
<td >
<?php echo $member['mobileNumber']. '       '.$member['nin'].'  '.$member['fname'].'  '.$member['lname']?>
                    </td>
   ...
   <?php        
$selectShares=mysqli_query($connection,"select shareID,date,amount from shares where member='$phone'");
...
<!-- Find total shares -->
  <?php
  $shareTotal=mysqli_query($connection,"select sum(amount) as totalShare from shares where member='$phone'");
  ...
  <tr>
                    ...
                    <td></td>
                    <td style="font-weight:bold;font-size:15px"><?php echo $sumShares ?></td>
