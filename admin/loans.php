...
<hr>
                ...
                <div class="col-12">
                  <div class="card " style="margin-left:20px">
                    <div class="card-header" style="color:rgb(61, 60, 60) !important;font-size:16px;font-weight:bold">Member's Loan</div>
             
                    <div class="container mt-4">
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        <li class="nav-item" role="presentation">
            <a class="nav-link active" id="tab1-tab" data-bs-toggle="tab" href="#membersForm" role="tab" aria-controls="tab1" aria-selected="true">Loan</a>
        </li>
        <li class="nav-item" role="presentation">
            <a class="nav-link" id="tab3-tab" data-bs-toggle="tab" href="#editUpdate" role="tab" aria-controls="tab3" aria-selected="false">Loans List</a>
        </li>
 ...
 background-color: white !important; /* Light blue background */
       ...
       <form name="" method="POST" action="loanAdd.php">
...
?>
  ...
  <button type="submit" name="addLoan" class="btn  submitBtn">Submit</button>
        ...
        <!-- show form after record selection -->
        <style>
              .hidden {
            display: none;
        }
...
.dt-paging{
        ...
        <div class="tab-pane fade" id="editUpdate" role="tabpanel" aria-labelledby="tab2-tab">
            ...
            <tbody>
              <?php
                 require "connectDB.php";
                 $selectShares=mysqli_query($connection,"select * from loans");
