          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="col-lg-12 col-md-12 col-12 mb-4" >
                    <button type="button" class="btn btn-success addBtn">Add Member</button>
...
<hr>
    ...
    <input type="hidden" class="form-control" name="nin" id="nin" disabled>
  </div>
</div>
            <div class="block1">
          <div class="mb-3">
...
<div class="block4">
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" name="address" id="address">
        ...
        <button type="submit" id="updateBtn" style="margin-bottom:20px;margin-left:100px" name="updateMembers" class="btn  submitBtn">Update</button>
