              ...
              <div class="row">
                ...
                <div class="col-lg-12 col-md-12 order-1">
                  <div class="row">
                    ...
                    <a class="btn addBtn" href="tenants-list.php" style="float:right">
  <i class="fas fa-plus"></i> Tenants
</a>
                ...
                <div class="col-12 col-lg-12 order-2 order-md-3 order-lg-2 mb-4">
                  <div class="card">
                    <div class="row row-bordered g-0">
                        ...
                        <h5 class="card-header m-0 me-2 pb-3">Tenants</h5>
                        <hr>
...
<h3 style="margin-top:30px">Update Record</h3>
        ...
        <div class="row">
          <div class="col-8">
            <div class="block1">
          <div class="mb-3">
          <input type="hidden" id="updateid" name="mobileNumber">
