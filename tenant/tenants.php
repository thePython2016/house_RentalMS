...
<div class="tab-container " >
    ...
    <div id="tab1" class="tab-content active">
      <!-- Tenants Form -->
       ...
       <input type="text" id="phoneTenant"  name="phone" class="form-control" maxlength="10" placeholder="076-111-1245" required>
   ...
   <div class="second-row-form">
     ...
     <div class="mb-3 mobile">
       ...
       <input type="text" id="kinPhone"  name="kinPhone" class="form-control" maxlength="10" placeholder="076-111-1245" required>
