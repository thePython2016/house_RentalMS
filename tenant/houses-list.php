...
<?php include 'main-menu.php'?>
  ...
  <i class="fas fa-plus"></i> House
                ...
                "' data-region='" . $houses['region'] . "' data-fee='" . $houses['rentalFee'] . 
...
<h3 style="margin-top:30px">Update Record</h3>
  ...
  <div class="mb-3">
    ...
    <input type="number" class="form-control" name="rentalFee" id="fee" >
  </div>
  </div>
  <!-- <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Attachment</label>
    <input type="" class="form-control" name="attachment" id="attachment" >
  </div> -->
</div>
